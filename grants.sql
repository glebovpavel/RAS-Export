...
grant select on sys.DBA_XS_SECURITY_CLASSES to &APP_SCHEMA;
grant select on sys.DBA_XS_SECURITY_CLASS_DEP to &APP_SCHEMA;
grant select on dba_xs_privileges to &APP_SCHEMA;
grant select on DBA_XS_IMPLIED_PRIVILEGES to &APP_SCHEMA;
grant select on sys.DBA_XS_POLICIES to &APP_SCHEMA;
